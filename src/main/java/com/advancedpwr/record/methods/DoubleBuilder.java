...
public class DoubleBuilder extends AbstractPrimitiveBuilder implements MethodWriterFactory
{
	...
	{
		JavaClassDescriptor doubleDescriptor = new JavaClassDescriptor( double.class );
		JavaClassDescriptor doubleClassDescriptor = new JavaClassDescriptor( Double.class );
